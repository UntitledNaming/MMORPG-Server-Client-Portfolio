...
#include "Network\ClientCore\MemoryPoolTLS.h"

std::unordered_map<ITEM_ID, ItemData*> FM1ItemTable::m_ItemTable;
CMPoolTLS<ItemData>* FM1ItemTable::m_pItemDataPool = nullptr;

void FM1ItemTable::Init()
{
...
void FM1ItemTable::Destroy()
{
	// itemTable�� ItemData* �ݳ� �� �ڷᱸ�� ����
...
const ItemData* FM1ItemTable::GetItemData(ITEM_ID ItemID)
{
