...
namespace FieldConst
{
	...
	constexpr uint16  DEFAULT_SECTOR_USER_COUNT       = 30;
	constexpr uint16  DEFAULT_SECTOR_MONSTER_COUNT    = 30;
	constexpr uint16  DEFAULT_SECTOR_ITEM_COUNT       = 30;
...
namespace UserConst
{
	...
	constexpr uint32  USER_PROGRESS_UPDATE_MIN_TIME  = 30000;
	constexpr uint32  USER_PROGRESS_UPDATE_MAX_TIME  = 60000;
}
